...
const Newpassord = () => {
  ...
  const number = location.state?.myValue; 
        ...
        try {
            ...
            if (fundenumber) {
                fetch(`https://backen-databace.onrender.com/api/product/${fundenumber._id}`, {
                    ...
                    body: JSON.stringify({
                        name: fundenumber.name,
                        email: fundenumber.email,
                        number: fundenumber.number,
                        password: password,   
                        payment_status: fundenumber.payment_status,
                        payment_id: fundenumber.payment_id,
                        payment_amount: fundenumber.payment_amount,
                        day: fundenumber.day
                    }),
                })
                return true;
